...
#' them to the package's standardized names.
#'
...
rename_columns_if_present <- function(df) {
  ...
  name_map <- c(
    ...
    "no_ncm_ing" = "ncm_name",
    "no_ncm_por" = "ncm_name_pt",
    "no_ncm_esp" = "ncm_name_es",
    "co_isic_classe" = "isic_class_code",
    "no_isic_classe" = "isic_class_name_pt",
    "no_isic_classe_ing" = "isic_class_name",
    "no_isic_classe_esp" = "isic_class_name_es",
    "co_isic_grupo" = "isic_group_code",
    "no_isic_grupo" = "isic_group_name_pt",
    "no_isic_grupo_ing" = "isic_group_name",
    "no_isic_grupo_esp" = "isic_group_name_es",
    "co_isic_divisao" = "isic_division_code",
    "no_isic_divisao" = "isic_division_name_pt",
    "no_isic_divisao_ing" = "isic_division_name",
    "no_isic_divisao_esp" = "isic_division_name_es",
    "co_isic_secao" = "isic_section_code",
    "no_isic_secao" = "isic_section_name_pt",
    "no_isic_secao_ing" = "isic_section_name",
    "no_isic_secao_esp" = "isic_section_name_es",
    "co_cgce_n3" = "bec_n3_code",
    "no_cgce_n3" = "bec_n3_name_pt",
    "no_cgce_n3_ing" = "bec_n3_name",
    "no_cgce_n3_esp" = "bec_n3_name_es",
    "co_cgce_n2" = "bec_n2_code",
    "no_cgce_n2" = "bec_n2_name_pt",
    "no_cgce_n2_ing" = "bec_n2_name",
    "no_cgce_n2_esp" = "bec_n2_name_es",
    "co_cgce_n1" = "bec_n1_code",
    "no_cgce_n1" = "bec_n1_name_pt",
    "no_cgce_n1_ing" = "bec_n1_name",
    "no_cgce_n1_esp" = "bec_n1_name_es",
    "co_unid" = "unit_code",
    ...
    "no_cuci_item" = "cuci_basic_heading_name_pt",
    "no_cuci_sub" = "cuci_subgroup_name_pt",
    "no_cuci_grupo" = "cuci_group_name_pt",
    "no_cuci_divisao" = "cuci_division_name_pt",
    "no_cuci_sec" = "cuci_section_name_pt"
    )
